        ...
        <div class="relative flex items-center justify-between h-16">
            ...
            <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <div class="hidden sm:block sm:ml-6">
                    <div class="flex">
                        <a href="{{route('home')}}" class="px-3 py-2 rounded-md text-sm font-medium leading-5 text-white focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out {{Route::currentRouteName() == 'home' ? 'bg-gray-900' : null}}">Dashboard</a>
                        <a href="{{route('books.index')}}" class="ml-4 px-3 py-2 rounded-md text-sm font-medium leading-5 text-gray-300 hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out {{Route::currentRouteName() == 'books.index' ? 'bg-gray-900' : null}}">Books</a>
                        <a href="{{route('issues.index')}}" class="ml-4 px-3 py-2 rounded-md text-sm font-medium leading-5 text-gray-300 hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out {{Route::currentRouteName() == 'issues.index' ? 'bg-gray-900' : null}}">My Issue History</a>
                    </div>
                </div>
            </div>
