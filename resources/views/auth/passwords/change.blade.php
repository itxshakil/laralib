...
<div class="container mx-auto flex justify-center px-3 md:px-6 my-12">
    <div class="w-full xl:w-3/4 lg:w-11/12 flex">
        <div class="w-full h-auto bg-gray-400 hidden lg:block lg:w-1/2 bg_cover rounded-l-lg"
            style="background-image: url('https://source.unsplash.com/K4mSJ7kc0As/600x800');background-position: center;">
        </div>
        <div class="w-full lg:w-1/2 bg-gray-100 p-2 md:p-5 rounded-lg shadow">
            <h1 class="pt-4 text-2xl text-center pb-2 md:pb-4">{{ __('Change your  Password') }}</h1>
            <form class="px-4 md:px-8  pt-6 pb-2 mb-4 bg-white rounded" method="POST"
                action="{{ route('password.change.submit') }}">
                <div class="mb-4">
                    ...
                    <input
                        ...
                        autocomplete="current-password" required aria-required="true" autofocus />
                ...
                <div class="mb-4">
                    ...
                    <input
                        ...
                        value="{{old('password')}}" placeholder="******************" required aria-required="true" />
                    @error('password')
                    <p class="text-xs italic text-red-500" role="alert">{{ $message }}</p>
                    @enderror
                </div>
                <div class="mb-4">
                    ...
                    <input
                        ...
                        name="password_confirmation" placeholder="******************" required aria-required="true" />
